...
class StadiumManagerTest : public ::testing::Test
{
    ...
    static StadiumManager sm;
};

TEST(StadiumManagerTest, AddStadiumToEmptyList) {
    StadiumManager sm;
    sm.stadium("Stadion Miejski Legii Warszawa", POLAND, "Warsaw", 80000);
...
TEST(StadiumManagerTest, AddStadiumToExistingList) {
    StadiumManager sm;
    sm.stadium("Stadion Miejski Legii Warszawa", POLAND, "Warsaw", 80000);
...
TEST(StadiumManagerTest, DeleteStadiumFromEmptyList)
{
    StadiumManager sm;
    auto* s = new Stadium();
